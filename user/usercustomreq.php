...
// For testing, assign a user_id (make sure that user exists in `users` table)
if (!isset($_SESSION['user_id'])) {
    $_SESSION['user_id'] = 1; // Change to a valid user id from users table
}
  ...
  <div class="row justify-content-center">
    <div class="col-lg-8 col-md-10">
      ...
      <div class="text-center">
        <a href="status.php" class="btn btn-outline-primary">View My Submissions</a>
      </div>
