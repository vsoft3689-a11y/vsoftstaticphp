                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <div class="ms-3">
                            ...
                            <p class="mb-0">Survey No. 64, Madhapur</p>
                        </div>
                    </div>
                    <div class="d-flex align-items-center mb-3">
                        <div class="d-flex align-items-center justify-content-center flex-shrink-0 bg-primary" style="width: 50px; height: 50px;">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-3">
                            ...
                            <p class="mb-0">info@vsoftsolutions.in</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <p class="mb-2"><i class="fa fa-map-marker-alt me-3">Survey No. 64, Madhapur,</i></p>
                    <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>+91-9441927859</p>
                    <p class="mb-2"><i class="fa fa-envelope me-3"></i>info@vsoftsolutions.in</p>
